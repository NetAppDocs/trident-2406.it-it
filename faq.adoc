...
Sì, Astra Trident può essere installato offline. Fai riferimento a link:../trident-install/kubernetes-deploy.html["Scopri di più sull'installazione di Astra Trident"^].
...
Il programma di installazione di Trident crea un Kubernetes ClusterRole, che ha accesso specifico alle risorse PersistentVolume, PersistentVolumeClaim, StorageClass e Secret del cluster Kubernetes. Fare riferimento a link:../trident-install/kubernetes-customize-deploy-tridentctl.html["Personalizzare l'installazione di tridentctl"^].
