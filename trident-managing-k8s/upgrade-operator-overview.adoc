...
TIP: Per ulteriori informazioni sull'architettura di Astra Trident nel cluster Kubernetes, consulta link:../trident-get-started/intro.html#astra-trident-architecture["Architettura Astra Trident"].
