...
.Prima di iniziare
* Assicurati di aver abilitato Astra Control Provisioner sul cluster Red Hat OpenShift gestito. Consulta link:../trident-use/enable-acp.html["Abilita Astra Control Provisioner"^] per le istruzioni.
* Assicurarsi di avere accesso all' `tridentctl` utilità.
